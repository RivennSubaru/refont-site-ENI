...
<body>
    ...
    <header>
        <div id="navigation">
            ...
            <div class="mode">
                <a href="./index-admin.php" class="admin-user user"><i class="fa-solid fa-lock"></i> Admin mode</a>
    ...
    <section id="Acceuil" class="Acceuil-blur">
        ...
        <div class="btn">
            <a href="../a propos/a propos_userView.php" class="boutons btn1" style="color: white; background: rgb(74, 74, 136);">Qui sommes-nous <i class="fa-solid fa-circle-info"></i></a>
            <a href="../contact/contact_userView.php#map" class="boutons btn2" style="color: white; background: rgb(0 212 138)">Emplacement <i class="fa-solid fa-map-location-dot"></i></a>
        </div>
    </section>
